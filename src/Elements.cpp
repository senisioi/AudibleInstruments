...
Elements::Elements() {
	...
	params[Elements::CONTOUR_PARAM].config(0.0, 1.0, 1.0, "Contour");
	params[Elements::BOW_PARAM].config(0.0, 1.0, 1.0, "Bow");
	params[Elements::BLOW_PARAM].config(0.0, 1.0, 0.0, "Blow");
	params[Elements::STRIKE_PARAM].config(0.0, 1.0, 0.5, "Strike");	
	params[Elements::COARSE_PARAM].config(-30.0, 30.0, 0.0, "Coarse");	
	params[Elements::FINE_PARAM].config(-2.0, 2.0, 0.0, "Fine");	
	params[Elements::FM_PARAM].config(-1.0, 1.0, 0.0, "FM");	
	params[Elements::FLOW_PARAM].config(0.0, 1.0, 0.5, "Flow");	
	params[Elements::MALLET_PARAM].config(0.0, 1.0, 0.5, "FM");
	params[Elements::GEOMETRY_PARAM].config(0.0, 1.0, 0.5, "Geometry");
	params[Elements::BRIGHTNESS_PARAM].config(0.0, 1.0, 0.5, "Brightness");
	params[Elements::BOW_TIMBRE_PARAM].config(0.0, 1.0, 0.5, "BowTimbre");
	params[Elements::BLOW_TIMBRE_PARAM].config(0.0, 1.0, 0.5, "BlowTimbre");
	params[Elements::STRIKE_TIMBRE_PARAM].config(0.0, 1.0, 0.5, "StrikeTimbre");
	params[Elements::DAMPING_PARAM].config(0.0, 1.0, 0.5, "Damping");
	params[Elements::POSITION_PARAM].config(0.0, 1.0, 0.5, "Position");
	params[Elements::SPACE_PARAM].config(0.0, 2.0, 0, "Space");
	params[Elements::BOW_TIMBRE_MOD_PARAM].config(-1.0, 1.0, 0, "BowTimbreMod");
	params[Elements::FLOW_MOD_PARAM].config(-1.0, 1.0, 0, "FlowMod");
	params[Elements::BLOW_TIMBRE_MOD_PARAM].config(-1.0, 1.0, 0, "BlowTimbreMod");
	params[Elements::PLAY_PARAM].config(0.0, 1.0, 0.0, "Play");
